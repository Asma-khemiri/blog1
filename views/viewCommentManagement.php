                    ...
                    <div class="single-post post-style-1">
						...
						<div class="blog-info">
                            ...
                            <ul class="post-footer">
                                <li><a href="admin&validateComment&id=<?= $comment['id'] ?>"><ion-icon name="checkbox"></ion-icon></a></li>
                                <li><a href="admin&deleteComment&id=<?= $comment['id'] ?>" onclick="return confirm('Voulez-vous supprimer définitivement ce commentaire ?')"><ion-icon name="remove"></ion-icon></a></li>
                            </ul>
						</div>
                    </div>
                </div>
